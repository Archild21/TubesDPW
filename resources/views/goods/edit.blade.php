            ...
            <div class="card-body">
                <form method="post" action="/dashboard/goods/{{ $good->id }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="id" value="{{ $good->id }}" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="tgl_masuk" value="{{ $good->tgl_masuk }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama" required
                                placeholder="Masukkan Nama Barang..." value="{{ $good->nama }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
