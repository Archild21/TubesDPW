        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="/dashboard/customers/{{ $customer->id }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama" required
                                placeholder="Masukkan Nama Pelanggan..." value="{{ $customer->nama }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="no_tlp"
                                placeholder="Masukkan Nomor Telepon..." value="{{ $customer->no_tlp }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <hr>
                    <button class="btn btn-primary" type="submit">Edit Pelanggan</button>
                </form>
            </div>
        </div>
    </div>
